...
public:
    ...
    void Initialize(Adafruit_PWMServoDriver& servo_ctlr, const int & servo_pin, const double & stand_angle_, const double & home_angle_, const double & offset_, const LegType & leg_type_, const JointType & joint_type_,
